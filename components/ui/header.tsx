        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link href="/demo">
                <Button variant="primary" size="md">Live Demo</Button>
              </Link>
            </div>
          ...
          <div className="md:hidden bg-slate-900/95 backdrop-blur-xl border-t border-slate-800/50">
            <nav className="px-4 py-4 space-y-1">
              ...
              <div className="pt-4 border-t border-slate-800 space-y-2">
                <Link href="https://github.com/DiDiTech-IL/pay-tachles" target="_blank" className="block" onClick={() => setMobileMenuOpen(false)}>
